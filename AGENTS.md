...
- Cilium BPF datapath can go stale on a node — pod egress breaks while host network works. Fix:
  delete the Cilium pod. See `docs/troubleshooting/cilium-stale-bpf-egress.md`
