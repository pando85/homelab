...
- When today's curve contains negative hours, `climate_control` sends a separate Telegram
  message after the schedule notification listing them as merged ranges, e.g.
  `Negative PVPC prices: 12-16h`
